...
class Grafo:
    def __init__(self):
        ...
        self.lista_enlazada.AgregarUltimo("Tom Hanks")
        self.lista_enlazada.AgregarUltimo("Meg Ryan")
        self.lista_enlazada.AgregarUltimo("Parker Posey")
        self.lista_enlazada.AgregarUltimo("Lisa Kudrow")        
    ...
    def imprimir_aristas_de_cada_nodo(self):
        ...
        for i in range(self.lista_enlazada.Tamanio()):
            print("")
            print("Las aristas (con su atributo pelicula) de",self.lista_enlazada.GetNodo(i),"son: ",(list(self.grafo.edges(self.lista_enlazada.GetNodo(i), data=True))))
